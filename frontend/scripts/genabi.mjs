...
const CONTRACT_NAME = "SecureData";

// <root>/secure-data (project root)
const rel = "../";
...
// Sepolia is optional - use localhost ABI if not deployed
let deploySepolia = readDeployment("sepolia", 11155111, CONTRACT_NAME, true /* optional */);
if (!deploySepolia) {
  console.log("Sepolia deployment not found, using localhost ABI for Sepolia");
  deploySepolia = { abi: deployLocalhost.abi, address: "0x0000000000000000000000000000000000000000", chainId: 11155111 };
}

// Skip ABI comparison check for now - allow different ABIs between networks
